...
<div id="wrapper">
    ...
    <div id="content" class="xgrid">
        ...
        <div class="x12">
            ...
            <h2>
                通水停水 - <a href="../page/be_orderInfo.html?id=B1-20140105-0001" target="orderInfo">${orderone.orderNo}</a>
...
<script type="text/javascript">
    ...
    function goback(OrderNo,type) {
        if(confirm("确定要撤回吗？")) {
            window.location.href = "../orderBack.action?OrderNo=" + OrderNo + "&&StepID=" + 7 + "&&type=" + type;
        }
    }

    function gook(OrderNo) {
        if(confirm("确定要发送吗？")) {
            window.location.href = "../tstsorderOk.action?OrderNo=" + OrderNo;
        }
    }
